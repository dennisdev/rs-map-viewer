...
export class Pathfinder {
    ...
    findPath(
            ...
            for (
                ...
                for (
                    ...
                    if (
                        ...
                        this.distances[graphX][graphY] >=
                            ALTERNATIVE_ROUTE_MAX_DISTANCE
                    ) {
                    ...
                    if (approxDestX <= checkX) {
                        deltaX =
                            1 -
                            approxDestX -
                            (routeStrategy.destSizeX - checkX);
                    ...
                    if (approxDestY <= checkY) {
                        deltaY =
                            1 -
                            approxDestY -
                            (routeStrategy.destSizeY - checkY);
                    ...
                    if (
                        cost < lowestCost ||
                        (cost <= lowestCost &&
                            this.distances[graphX][graphY] < lowestDistance)
                    ) {
        ...
        let traceY = endY;
        let direction =
            this.directions[traceX - graphBaseX][traceY - graphBaseY];
    ...
    findPathS1_2(
        ...
        while (read != write) {
            ...
            if (
                ...
                _directions[currentGraphX - 1][currentGraphY] =
                    DirectionFlag.EAST;
            ...
            if (
                ...
                _directions[currentGraphX][currentGraphY - 1] =
                    DirectionFlag.NORTH;
    ...
    findPathS1(
        ...
        while (var11 != var10) {
            ...
            if (
                var6 > 0 &&
                this.directions[var6 - 1][var7] == 0 &&
                (var12[var13 - 1][var14] & 19136776) == 0
            ) {
            ...
            if (
                var6 < 127 &&
                this.directions[var6 + 1][var7] == 0 &&
                (var12[var13 + 1][var14] & 19136896) == 0
            ) {
                this.bufferX[var10] = var4 + 1;
                this.bufferY[var10] = var5;
                var10 = (var10 + 1) & 4095;
            ...
            if (
                var6 > 0 &&
                var7 > 0 &&
                this.directions[var6 - 1][var7 - 1] == 0 &&
                (var12[var13 - 1][var14 - 1] & 19136782) == 0 &&
                (var12[var13 - 1][var14] & 19136776) == 0 &&
                (var12[var13][var14 - 1] & 19136770) == 0
            ) {
                this.bufferX[var10] = var4 - 1;
            ...
            if (
                ...
                var7 < 127 &&
                this.directions[var6 + 1][var7 + 1] == 0 &&
                (var12[var13 + 1][var14 + 1] & 19136992) == 0 &&
                (var12[var13 + 1][var14] & 19136896) == 0 &&
                (var12[var13][var14 + 1] & 19136800) == 0
            ) {
                this.bufferX[var10] = var4 + 1;
        ...
        while (read != write) {
            ...
            if (
                ...
                exit: do {
                    ...
                    _distances[currentGraphX - 1][currentGraphY - 1] =
                        nextDistance;
                } while (false);
            }
            if (
