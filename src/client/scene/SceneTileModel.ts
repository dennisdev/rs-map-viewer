...
export class SceneTileModel {
    ...
    constructor(shape: number, rotation: number, textureId: number, x: number, y: number,
        ...
        for (let i = 0; i < faceCount; i++) {
            ...
            this.faces.push({
                vertices: [
                    { x: vertexX[a], y: vertexY[a], z: vertexZ[a], hsl: hslA, u: u0, v: v0, textureId: faceTextureId },
                    { x: vertexX[b], y: vertexY[b], z: vertexZ[b], hsl: hslB, u: u1, v: v1, textureId: faceTextureId },
                    { x: vertexX[c], y: vertexY[c], z: vertexZ[c], hsl: hslC, u: u2, v: v2, textureId: faceTextureId },
                ]
            });
        }
    }
